...
<header class="main-header">
    <div class="main-header__container container">
        ...
        <form class="main-header__search" method="get" action="search.php">
            <input type="search" name="search" placeholder="Поиск лота" value="<?php if ($_SERVER['REQUEST_METHOD'] === 'GET' && isset($_GET['search'])){ echo $search;} else { echo '';} ?>">
        ...
        <nav class="user-menu">
            ...
            <?php if (isset($_SESSION['user'])): ?>
              <div class="user-menu__image">
                <img src="img/user-pics/<?=$user['avatar'];?>" width="40" height="40" alt="Пользователь">
              </div>
